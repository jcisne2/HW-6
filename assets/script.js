var APIkey = "fe02ed3d139cddb531535ec31fcdf624";
...
function getWeather(data) {
    ...
    fetch(requestUrl)
        ...
        .then(function(data) {
            ...
            // get date from results and display 
            ...
            // if statement that gives the color
            if ( currentCityUV < 3 ) {
...
// use Open Weather to get cordinates and retreive data
...
// handle submit of city name by displaying weather data
...
// using local storage to retrieve past cities
